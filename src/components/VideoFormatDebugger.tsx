	...
	return (
		<Card className="mx-auto w-full max-w-4xl">
			...
			<CardContent className="space-y-6">
				{/* Browser Info */}
				<div>
					<h3 className="mb-2 font-semibold">Informações do Navegador</h3>
				...
				{/* Current Format Info */}
				<div>
					<h3 className="mb-2 font-semibold">Formato Atual Selecionado</h3>
					...
					<div className="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
						<div className="mb-2 flex items-center gap-2">
							...
							<span className="font-medium">
								MP4 - Configurações Otimizadas
							</span>
						</div>
						<div className="space-y-2 text-sm text-red-700 dark:text-red-300">
							<div>
								<strong>Melhorias de Áudio:</strong>
								<ul className="mt-1 ml-4 space-y-1">
									<li>• Codec AAC configurado automaticamente</li>
									<li>• Bitrate de áudio otimizado por qualidade</li>
									<li>• Mime types específicos para MP4 com áudio</li>
									<li>• Fallback inteligente para melhor compatibilidade</li>
								</ul>
							</div>
							...
							{typeof navigator !== "undefined" &&
								navigator.platform.toLowerCase().includes("win") && (
									<div>
										<strong>Otimizações Windows:</strong>
										<ul className="mt-1 ml-4 space-y-1">
											<li>• Bitrate de áudio conservador (64-128 kbps)</li>
											<li>• Frame rate reduzido para estabilidade</li>
											<li>• Chunks maiores para evitar travamentos</li>
										</ul>
									</div>
								)}

							<p className="mt-2">
								<strong>Recomendação:</strong> WebM ainda oferece melhor
								performance geral.
							</p>
						</div>
					</div>
