        ...
        {format === "mp4" && (
          <div className="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="font-medium">Aviso - MP4 no Windows</span>
            </div>
            <div className="space-y-1 text-sm text-red-700 dark:text-red-300">
              <p>
                <strong>Problema conhecido:</strong> MP4 no Windows pode causar
                travamentos durante a geração do vídeo devido a limitações do
                MediaRecorder API.
              </p>
              <p>
                <strong>Soluções aplicadas automaticamente:</strong>
              </p>
              <ul className="mt-2 ml-4 space-y-1">
                <li>• Bitrate ultra reduzido para 300-350 Kbps</li>
                <li>• Frame rate limitado a 8-10 FPS</li>
                <li>• Resolução máxima de 800px</li>
                <li>• Chunks extra grandes (20 segundos)</li>
              </ul>
              <p className="mt-2">
                <strong>Recomendação:</strong> Use WebM para melhor estabilidade
                no Windows.
              </p>
            </div>
          </div>
